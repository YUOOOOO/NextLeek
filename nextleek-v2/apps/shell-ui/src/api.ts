export interface PluginManifest {
  ...
  minCreatorVersion?:string; capabilities:string[]; permissions:string[]
}
...
export interface PluginState { manifest:PluginManifest; builtin:boolean; trusted:boolean }
...
export function createMemoryApi(installed:PluginState[]):KernelApi {
  ...
  const settings:SettingsView = {settings:{marketUrl:'https://raw.githubusercontent.com/YUOOOOO/NextLeek-Plugins/main/index.json',trustedPlugins:[]},version:'0.1.0',dataDir:'Data'}
  return {
